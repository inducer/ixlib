...
#if __GNUC__ < 3
  #include <hash_map>
  #define IXLIB_HASH_MAP_TYPE std::hash_map
#else
  #include <ext/hash_map>
  #define IXLIB_HASH_MAP_TYPE __gnu_cxx::hash_map
#endif
  ...
  */
  namespace javascript {
    ...
    class list_scope : public value {
      protected:
        typedef IXLIB_HASH_MAP_TYPE<std::string,ref<value>,string_hash> member_map;
