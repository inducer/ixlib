...
ixion::TSize ixion::regex<T>::backref_stack::size() {
  TSize result = 0;
  FOREACH_CONST(first,Stack,typename internal_stack)
...
template<class T>
typename ixion::regex<T>::matcher *
ixion::regex<T>::quantifier::duplicate() const {
...
template<class T>
typename ixion::regex<T>::matcher *
ixion::regex<T>::sequence_matcher::duplicate() const {
...
template<class T>
typename ixion::regex<T>::matcher *
ixion::regex<T>::any_matcher::duplicate() const {
...
template<class T>
typename ixion::regex<T>::matcher *
ixion::regex<T>::start_matcher::duplicate() const {
...
template<class T>
typename ixion::regex<T>::matcher *
ixion::regex<T>::end_matcher::duplicate() const {
...
template<class T>
typename ixion::regex<T>::matcher *
ixion::regex<T>::backref_open_matcher::duplicate() const {
...
template<class T>
bool ixion::regex<T>::backref_open_matcher::match(
...
template<class T>
typename ixion::regex<T>::matcher *
ixion::regex<T>::backref_close_matcher::duplicate() const {
...
template<class T>
typename ixion::regex<T>::matcher *
ixion::regex<T>::alternative_matcher::duplicate() const {
...
ixion::TSize ixion::regex<T>::alternative_matcher::minimumMatchLength() const {
  ...
  FOREACH_CONST(first,AltList,typename alt_list)
    if (is_first) {
...
bool ixion::regex<T>::alternative_matcher::match(backref_stack &brstack,T const &candidate,TIndex at) {
  typename std::vector<matcher *>::iterator 
...
template<class T>
typename ixion::regex<T>::matcher *
ixion::regex<T>::backref_matcher::duplicate() const {
